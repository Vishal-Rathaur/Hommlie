...
import com.ikksa.user.api.RestResponse
import com.ikksa.user.base.BaseActivity
import com.ikksa.user.databinding.ActSignUpBinding
import com.ikksa.user.model.RegistrationModel
    ...
    private fun signup() {
        if (intent.getStringExtra("loginType") != null) {
            if (signUpBinding.edtMobile.text.toString().equals("")) {
                ...
                hasmap["mobile"] = "+966" + signUpBinding.edtMobile.text.toString()
            ...
            }else if(signUpBinding.edtMobile.text.toString().startsWith("0")) {
                showErrorFullMsg(this@ActSignUp,
                    resources.getString(R.string.validation_valid_mobile_zero)
                )
            }
           else if (!Common.isValidMobile(signUpBinding.edtMobile.text.toString())) {
                showErrorFullMsg(
                    this@ActSignUp,
                    resources.getString(R.string.validation_valid_mobile)
                )
            } else if (signUpBinding.edtMobile.text.toString().equals("")) {
                showErrorFullMsg(this@ActSignUp, resources.getString(R.string.validation_valid_mobile))
