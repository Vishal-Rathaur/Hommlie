...
import com.ikksa.user.databinding.ActVendorsDetailsBinding
import com.ikksa.user.databinding.RowGravityBinding
import com.ikksa.user.databinding.RowStoreBannerBinding
import com.ikksa.user.model.TopbannerItem
import com.ikksa.user.model.VendorsDetailsDataItem
import com.ikksa.user.model.VendorsDetailsResponse
    ...
    private fun loadPagerImagesSliders(slidersList: ArrayList<TopbannerItem>) {
        ...
        val bannerAdapter = object :
            ...
            override fun onBindData(
                ...
                Glide.with(this@ActVendorsDetails).load(
                    Common.filterHttps(slidersList[position].imageUrl))
            ...
            object : BaseAdaptor<VendorsDetailsDataItem, RowGravityBinding>(
                ...
                override fun onBindData(
                    ...
                    Glide.with(this@ActVendorsDetails)
                        .load(filterHttps(vendorsdetailsDataList[position].productimage?.imageUrl))
