...
import com.ikksa.user.databinding.ActOrderDetailsBinding
import com.ikksa.user.databinding.RemoveItemDialogBinding
import com.ikksa.user.databinding.RowOrderdetailsproductBinding
            ...
            object : BaseAdaptor<OrderDataItem, RowOrderdetailsproductBinding>(
                ...
                override fun onBindData(
                    ...
                    Glide.with(this@ActOrderDetails)
                        .load(filterHttps(orderData[position].imageUrl)).into(binding.ivCartitemm)
