...
import com.ikksa.user.databinding.ActBrandDetailsBinding
import com.ikksa.user.databinding.RowGravityBinding
            ...
            object : BaseAdaptor<BrandDetailsDataItem, RowGravityBinding>(
                ...
                override fun onBindData(
                    ...
                    Glide.with(this@ActBrandDetails)
                        .load(filterHttps(branddetailsDataList[position].productimage?.imageUrl)).into(binding.ivCartitemm)
