...
import com.ikksa.user.databinding.ActPayStackBinding
import com.ikksa.user.utils.CreditCardTextFormatter
...
class ActPayStack : AppCompatActivity() {
    ...
    private fun handleClicks() {
        binding.btnPay.setOnClickListener {
            if (com.ikksa.user.utils.Common.isCheckNetwork(this@ActPayStack)) {
