...
import com.ikksa.user.databinding.ActCheckoutBinding
import com.ikksa.user.databinding.RowCheckoutBinding
...
class ActCheckout : BaseActivity() {
            ...
            object : BaseAdaptor<CheckOutDataItem, RowCheckoutBinding>(
                ...
                override fun onBindData(
                    ...
                    Glide.with(this@ActCheckout)
                        .load(filterHttps(checkOutDataList[position].imageUrl)).into(binding.ivCartitemm)
    ...
    private fun loadCheckOutDetails(checkOutList: CheckOutData) {
        ...
        if (currencyPosition == "left") {
            ...
            checkoutBinding.tvshippingtotal.text = currency+ "" + highShippingCharge.toString()
            ...
            checkoutBinding.tvshippingtotal.text = highShippingCharge.toString()+ "" + currency
