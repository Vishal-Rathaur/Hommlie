...
import com.ikksa.user.databinding.ActTrackOrderBinding
import com.ikksa.user.model.TrackOrderInfo
import com.ikksa.user.model.TrackOrderResponse
import com.ikksa.user.utils.Common
import com.ikksa.user.utils.Common.filterHttps
import com.ikksa.user.utils.Common.getDateTime
    ...
    private fun loadTrackOrderDetails(trackOrderDetailsList: TrackOrderInfo) {
        if (!trackOrderDetailsList.equals(0)) {
            ...
            Glide.with(this@ActTrackOrder)
                .load(filterHttps(trackOrderDetailsList.imageUrl)).into(trackOrderBinding.ivOrderTrack)
