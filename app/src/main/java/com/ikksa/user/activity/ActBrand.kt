...
import com.ikksa.user.databinding.ActBrandBinding
import com.ikksa.user.databinding.RowBrandsBinding
    ...
    private fun loadBrandDataList(brandDataList: ArrayList<BrandDataItem>) {
        ...
        bannerAdapter = object :
            ...
            override fun onBindData(
                ...
                Glide.with(this@ActBrand).load(filterHttps(brandDataList[position].imageUrl)).into(binding.ivBrands)
