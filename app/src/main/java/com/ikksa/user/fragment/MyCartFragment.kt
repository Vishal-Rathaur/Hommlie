...
import com.ikksa.user.activity.ActCheckout
import com.ikksa.user.activity.ActLogin
import com.ikksa.user.activity.ActProductDetails
...
import com.ikksa.user.databinding.FragMyCartBinding
import com.ikksa.user.databinding.RemoveItemDialogBinding
import com.ikksa.user.databinding.RowMycartBinding
import com.ikksa.user.model.CartDataItem
import com.ikksa.user.model.GetCartResponse
...
import com.ikksa.user.utils.Common.showErrorFullMsg
import com.ikksa.user.utils.Common.showLoadingProgress
import com.ikksa.user.utils.SharePreference
import com.ikksa.user.utils.SharePreference.Companion.getStringPref
            ...
            object : BaseAdaptor<CartDataItem, RowMycartBinding>(
                ...
                override fun onBindData(
                    ...
                    Glide.with(requireActivity())
                        .load(filterHttps(cartDataList[position].imageUrl)).into(binding.ivCartitemm)
