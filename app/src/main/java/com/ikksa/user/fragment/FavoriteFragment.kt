...
import com.ikksa.user.databinding.FragFavoriteBinding
import com.ikksa.user.databinding.RemoveItemDialogBinding
import com.ikksa.user.databinding.RowViewallBinding
import com.ikksa.user.model.GetWishListResponse
import com.ikksa.user.model.WishListDataItem
        ...
        val wishListDataAdapter =
            object : BaseAdaptor<WishListDataItem, RowViewallBinding>(
                ...
                override fun onBindData(
                    ...
                    if(wishListDataList[position].productPrice!!.toDouble().equals(wishListDataList[position].discountedPrice!!.toDouble())){
                    ...
                    val wp = filterHttps(wishListDataList[position].productimage?.imageUrl)
