...
import com.hommlie.user.databinding.ActPayStackBinding
import com.hommlie.user.utils.CreditCardTextFormatter
...
class ActPayStack : AppCompatActivity() {
    ...
    private fun handleClicks() {
        binding.btnPay.setOnClickListener {
            if (com.hommlie.user.utils.Common.isCheckNetwork(this@ActPayStack)) {
