...
import com.hommlie.user.databinding.ActReviewsBinding
import com.hommlie.user.databinding.RowReviewsBinding
...
class ActReviews : BaseActivity() {
            ...
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    if (restResponce.status == 1) {
                        ...
                        restResponce.allReview?.let { loadProductReviewData(it) }
            ...
            object : BaseAdaptor<ReviewDataItem, RowReviewsBinding>(
                ...
                override fun onBindData(
                    ...
                    Glide.with(this@ActReviews)
                        .load(
                            Common.filterHttps(reviewsUserdata[position].users?.imageUrl)).placeholder(
    ...
    private fun loadProductReview(productDetailsReviews: Reviews) {
        ...
        if (productDetailsReviews.avgRatting == "0.0" || productDetailsReviews.avgRatting == "0.5") {
            ...
            reviewsBinding.ivRatting.setColorFilter(getColor(R.color.darkyellow))
        } else if (productDetailsReviews.avgRatting == "4" || productDetailsReviews.avgRatting == "4.9") {
