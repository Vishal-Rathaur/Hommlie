...
data class BannerResponse(
    ...
    @field:SerializedName("bannerReferEarn")
    val bannerReferEarn: ArrayList<TopbannerItem>? = null,

    @field:SerializedName("bannerQuickService")
    val bannerQuickService: ArrayList<TopbannerItem>? = null,

    @field:SerializedName("bannerPest")
    val bannerPest: ArrayList<TopbannerItem>? = null,

    @field:SerializedName("bannerMosqito")
    val bannerMosqito: ArrayList<TopbannerItem>? = null,

    @field:SerializedName("bannerBird")
    val bannerBird: ArrayList<TopbannerItem>? = null,
